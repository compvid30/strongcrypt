...
begin
  ...
  if (SDUMessageDlg(_('WARNING!')+SDUCRLF+
                 SDUCRLF+
                 _('Stopping a StrongCrypt driver which is currently in use (e.g. by one or more mounted volumes) can lead to SYSTEM INSTABILITY.')+SDUCRLF+
                 SDUCRLF+
...
begin
  ...
  if (SDUMessageDlg(_('WARNING!')+SDUCRLF+
               SDUCRLF+
               _('Uninstalling a StrongCrypt driver which is currently in use (e.g. by one or more mounted volumes) can lead to SYSTEM INSTABILITY.')+SDUCRLF+
               SDUCRLF+
               _('This option is intended for experienced users who REALLY know what they''re doing.')+SDUCRLF+
               SDUCRLF+
