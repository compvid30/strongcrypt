...
begin
  ...
  reInstructFileOrPartition.Text :=
    _('If you would like to modify an encrypted volume, please specify whether it is file or partition based.'
      + SDUCRLF +
    SDUCRLF +
  ...
  reInstructRNGSelect.Text :=
    _('In order to change your volume/keyfile''s details, a certain amount of random data is required.'
      + SDUCRLF +
    SDUCRLF +
